...
//CROPS
		BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), BlockRegistry.TOMATO_CROP, BlockRegistry.LEEK_CROP, BlockRegistry.LETTUCE_CROP, BlockRegistry.CORN_CROP);
	}
}